...
UniversalOptimizer_FILES = GUI.x scale.xm cpu_priority_booster.xm input_lag_reduce.xm ram_optimizer.xm thermal_bypass.xm animation_killer.xm network_blocker.xm anti_blur.xm hud_overlay.xm
